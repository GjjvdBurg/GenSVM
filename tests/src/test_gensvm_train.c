...
char *test_gensvm_train_seed_linear()
{
	...
	matrix_set(data->y, data->n, 1, 0, 0, 2);
	matrix_set(data->y, data->n, 1, 1, 0, 1);
	matrix_set(data->y, data->n, 1, 2, 0, 3);
	matrix_set(data->y, data->n, 1, 3, 0, 2);
	matrix_set(data->y, data->n, 1, 4, 0, 3);
	matrix_set(data->y, data->n, 1, 5, 0, 2);
	matrix_set(data->y, data->n, 1, 6, 0, 4);
	matrix_set(data->y, data->n, 1, 7, 0, 1);
	...
	matrix_set(seed->V, data->m+1, data->K-1, 1, 0, 0.7956168453294307);
	matrix_set(seed->V, data->m+1, data->K-1, 1, 1, 0.3267543833513200);
	matrix_set(seed->V, data->m+1, data->K-1, 1, 2, 0.8659836346403005);
	matrix_set(seed->V, data->m+1, data->K-1, 2, 0, 0.5777227081256917);
	matrix_set(seed->V, data->m+1, data->K-1, 2, 1, 0.3693175185473680);
	matrix_set(seed->V, data->m+1, data->K-1, 2, 2, 0.2728942849022845);
	matrix_set(seed->V, data->m+1, data->K-1, 3, 0, 0.4426030703804438);
	matrix_set(seed->V, data->m+1, data->K-1, 3, 1, 0.2456426390463990);
	matrix_set(seed->V, data->m+1, data->K-1, 3, 2, 0.2665038412777220);
...
char *test_gensvm_train_seed_kernel()
{
	...
	data->Z = data->RAW;
	matrix_set(data->Z, data->n, data->m+1, 0, 0, 1.0000000000000000);
	matrix_set(data->Z, data->n, data->m+1, 0, 1, 0.0657799204744603);
	matrix_set(data->Z, data->n, data->m+1, 0, 2, 0.2576653302581353);
	matrix_set(data->Z, data->n, data->m+1, 0, 3, 0.0221000752651170);
	matrix_set(data->Z, data->n, data->m+1, 0, 4, 0.6666929354133441);
	matrix_set(data->Z, data->n, data->m+1, 0, 5, 0.6178892590244618);
	matrix_set(data->Z, data->n, data->m+1, 1, 0, 1.0000000000000000);
	matrix_set(data->Z, data->n, data->m+1, 1, 1, 0.9797668012781366);
	matrix_set(data->Z, data->n, data->m+1, 1, 2, 0.7636361573939686);
	matrix_set(data->Z, data->n, data->m+1, 1, 3, 0.3195806959299131);
	matrix_set(data->Z, data->n, data->m+1, 1, 4, 0.2947771273705799);
	matrix_set(data->Z, data->n, data->m+1, 1, 5, 0.8358899802514324);
	matrix_set(data->Z, data->n, data->m+1, 2, 0, 1.0000000000000000);
	matrix_set(data->Z, data->n, data->m+1, 2, 1, 0.9473849700145257);
	matrix_set(data->Z, data->n, data->m+1, 2, 2, 0.8682867844262768);
	matrix_set(data->Z, data->n, data->m+1, 2, 3, 0.7116177283612393);
	matrix_set(data->Z, data->n, data->m+1, 2, 4, 0.5092752476335579);
	matrix_set(data->Z, data->n, data->m+1, 2, 5, 0.1046097156193449);
	matrix_set(data->Z, data->n, data->m+1, 3, 0, 1.0000000000000000);
	matrix_set(data->Z, data->n, data->m+1, 3, 1, 0.5846585351601830);
	matrix_set(data->Z, data->n, data->m+1, 3, 2, 0.4076887966131124);
	matrix_set(data->Z, data->n, data->m+1, 3, 3, 0.8661556045821296);
	matrix_set(data->Z, data->n, data->m+1, 3, 4, 0.0904082115920005);
	matrix_set(data->Z, data->n, data->m+1, 3, 5, 0.0799888711622944);
	matrix_set(data->Z, data->n, data->m+1, 4, 0, 1.0000000000000000);
	matrix_set(data->Z, data->n, data->m+1, 4, 1, 0.8112201081242789);
	matrix_set(data->Z, data->n, data->m+1, 4, 2, 0.3112642417912803);
	matrix_set(data->Z, data->n, data->m+1, 4, 3, 0.7902557587124555);
	matrix_set(data->Z, data->n, data->m+1, 4, 4, 0.3001992968661185);
	matrix_set(data->Z, data->n, data->m+1, 4, 5, 0.6030590437920392);
	matrix_set(data->Z, data->n, data->m+1, 5, 0, 1.0000000000000000);
	matrix_set(data->Z, data->n, data->m+1, 5, 1, 0.0098576324913424);
	matrix_set(data->Z, data->n, data->m+1, 5, 2, 0.5686603332895077);
	matrix_set(data->Z, data->n, data->m+1, 5, 3, 0.9933970661175713);
	matrix_set(data->Z, data->n, data->m+1, 5, 4, 0.5215400841900655);
	matrix_set(data->Z, data->n, data->m+1, 5, 5, 0.4307310515440625);
	matrix_set(data->Z, data->n, data->m+1, 6, 0, 1.0000000000000000);
	matrix_set(data->Z, data->n, data->m+1, 6, 1, 0.2773296707204919);
	matrix_set(data->Z, data->n, data->m+1, 6, 2, 0.5114254316901164);
	matrix_set(data->Z, data->n, data->m+1, 6, 3, 0.5057613745592034);
	matrix_set(data->Z, data->n, data->m+1, 6, 4, 0.6411421568717217);
	matrix_set(data->Z, data->n, data->m+1, 6, 5, 0.3114658800558432);
	matrix_set(data->Z, data->n, data->m+1, 7, 0, 1.0000000000000000);
	matrix_set(data->Z, data->n, data->m+1, 7, 1, 0.7195909422652624);
	matrix_set(data->Z, data->n, data->m+1, 7, 2, 0.7754155342547566);
	matrix_set(data->Z, data->n, data->m+1, 7, 3, 0.5955643008534165);
	matrix_set(data->Z, data->n, data->m+1, 7, 4, 0.5920949759391909);
	matrix_set(data->Z, data->n, data->m+1, 7, 5, 0.7029537245575100);
	matrix_set(data->Z, data->n, data->m+1, 8, 0, 1.0000000000000000);
	matrix_set(data->Z, data->n, data->m+1, 8, 1, 0.3792168380438625);
	matrix_set(data->Z, data->n, data->m+1, 8, 2, 0.1920178667928286);
	matrix_set(data->Z, data->n, data->m+1, 8, 3, 0.2742847467912714);
	matrix_set(data->Z, data->n, data->m+1, 8, 4, 0.2337979820454409);
	matrix_set(data->Z, data->n, data->m+1, 8, 5, 0.3978991644742557);
	matrix_set(data->Z, data->n, data->m+1, 9, 0, 1.0000000000000000);
	matrix_set(data->Z, data->n, data->m+1, 9, 1, 0.0797813938980598);
	matrix_set(data->Z, data->n, data->m+1, 9, 2, 0.5863311792537960);
	matrix_set(data->Z, data->n, data->m+1, 9, 3, 0.8565105304166337);
	matrix_set(data->Z, data->n, data->m+1, 9, 4, 0.8266471128109379);
	matrix_set(data->Z, data->n, data->m+1, 9, 5, 0.8070610088865674);
