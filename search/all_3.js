...
[
  ...
  ['dsyevx',['dsyevx',['../gensvm__kernel_8h.html#a36d0f7deb87d01203d8f3a0a49f6f0f7',1,'dsyevx(char JOBZ, char RANGE, char UPLO, int N, double *A, int LDA, double VL, double VU, int IL, int IU, double ABSTOL, int *M, double *W, double *Z, int LDZ, double *WORK, int LWORK, int *IWORK, int *IFAIL):&#160;gensvm_kernel.c'],['../gensvm__kernel_8c.html#a36d0f7deb87d01203d8f3a0a49f6f0f7',1,'dsyevx(char JOBZ, char RANGE, char UPLO, int N, double *A, int LDA, double VL, double VU, int IL, int IU, double ABSTOL, int *M, double *W, double *Z, int LDZ, double *WORK, int LWORK, int *IWORK, int *IFAIL):&#160;gensvm_kernel.c']]],
  ['dsysv',['dsysv',['../gensvm__update_8h.html#a015783619d7f097db396c176e0ff99a5',1,'dsysv(char UPLO, int N, int NRHS, double *A, int LDA, int *IPIV, double *B, int LDB, double *WORK, int LWORK):&#160;gensvm_update.c'],['../gensvm__update_8c.html#a015783619d7f097db396c176e0ff99a5',1,'dsysv(char UPLO, int N, int NRHS, double *A, int LDA, int *IPIV, double *B, int LDB, double *WORK, int LWORK):&#160;gensvm_update.c']]],
  ['default_20data_20file_20specification',['Default Data File Specification',['../spec_data_file.html',1,'']]]
];
